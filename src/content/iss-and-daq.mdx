...
<CaptionImage image="/soldering.JPEG" caption="A typical evening" w="500" h="500" float="right" />
...
<CaptionImage image="/adctransaction.png" caption="The ADC's transaction involves the master sending three control bits (ADDx) for the next conversion, while the ADC sends its conversions in parallel, starting with 4 zeroes (Zx)." w="1800" h="800" />
...
<CaptionImage image="/wiring.JPG" caption="Wiring up the pressure transmitter" w="300" h="200" float="left" />
...
<CaptionImage image="/cheese.JPG" caption="This man did not know about the smart thermostat" w="400" h="300" float="right"/>
...
<CaptionImage image="/finished.JPEG" caption="Test stand awaiting motor" w="400" h="300" float="left" />
...
<CaptionImage image="/hybridhotfire.jpg" caption="The hybrid hotfire" w="1200" h="800"/>
...
<CaptionImage image="/rip.JPEG" caption="RIP" w="400" h="600" float="right" />
