  ...
  return (
    <div className="flex flex-row justify-center">
      <div className="flex flex-col h-screen w-1/2 max-sm:w-screen max-sm:mx-4">
        ...
        <p className="my-4">
          The following are all projects I&apos;ve developed on my own time and consider &quot;complete&quot;.
          They are sorted from oldest to newest, and as a result, likely from highest to lowest code quality.
        </p>
        <div>
          <ProjectCard name="parse_rc_ibus" url="https://github.com/mariano-f-r/parse_rc_ibus" 
            tech="Rust"
          ...
          <ProjectCard name="vexdoc" url="https://github.com/mariano-f-r/vexdoc" 
            tech="Rust, CLI"
          ...
          <ProjectCard name="chatter" url="https://github.com/mariano-f-r/chatter" 
          ...
          <ProjectCard name="ToDoer" url="https://github.com/mariano-f-r/ToDoer" 
            tech="Swift, UIKit, SQLite3"
            desc="A simple to-do list app that I made as a capstone project" />
          <ProjectCard name="my-recipe-app" url="https://github.com/mariano-f-r/my-recipe-app" 
          ...
          <ProjectCard name="new-webapp" url="https://github.com/mariano-f-r/new-webapp" 
            tech="Python, Django, PostgreSQl, Heroku"
